...
|{{site.data.keyword.loganalysisfull}} | 댈러스, 미국에서 호스팅됨 | 지역에서 사용할 수 없음 | 프랑크푸르트, 독일에서 호스팅됨 | 지역에서 사용할 수 없음 | 시드니, 호주에서 호스팅됨 |
...
|{{site.data.keyword.keymanagementserviceshort}} | 댈러스, 미국에서 호스팅됨	| 런던, 영국에서 호스팅됨	| 지역에서 사용할 수 없음 | 지역에서 사용할 수 없음 | 지역에서 사용할 수 없음	|
